...
int main(int argc, char **argv) {
     ...
     * Every process (including root) allocates just its own small chunk.
     */
    int *array = NULL;
    ...
    /*
     * SCATTER: Root splits array[] into 'size' pieces and sends piece i
     * to rank i. sendcount is the number of elements sent to EACH process
     * (chunk_size), NOT the total array size N.
     * sendbuf (array) is only meaningful on root; it is NULL elsewhere.
     */
