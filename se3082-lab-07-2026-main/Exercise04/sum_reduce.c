...
int main(int argc, char **argv) {
    ...
    /*
     * REDUCE: combine every process's local_sum with MPI_SUM and put the
     * result in total_sum on root. No all_sums array, no manual loop.
     * total_sum is only valid on root afterwards.
     */
